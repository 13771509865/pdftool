 ...
 $(function() {
     var appendStr = '<div id="zoom">' +
         ...
         '</div>';
     var rotateStr = '<a class="rightButton" id="rotateLeft" title="向左旋转" style="float:right;padding: 10px;" href="javascript:;" onclick="rotate(0)">' +
         '<img src="' + basePath + '/rotate_left.png" width="16" height="16">' +
         '</a>' +
         '<a class="rightButton" title="向右旋转旋转" id="rotateRight" style="float:right;padding: 10px;" href="javascript:;" onclick="rotate(1)"> ' +
         '<img src="' + basePath + '/rotate_right.png" width="16" height="16" >' +
         '</a>';
 ...
 function changeTab(type) {
     ...
     $("#scale_text,.zoomArea span").html(Math.round(size * 100) + "%")
     isZoom = true;
     renderPage();
