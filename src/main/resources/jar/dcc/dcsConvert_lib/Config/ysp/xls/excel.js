$(function(){
	...
	$(".excel-tab-title li>a").click(function(){
		...
		$(".dropdown-menu li a[href='"+activeTab+"']").parent().addClass("active");
	})
	$(".dropdown-menu li>a").click(function(){
		$(".excel-tab-title li,.dropdown-menu li").removeClass("active");
		var activeTab = ($(this).attr("href"));
		$(".excel-tab-title li a[href='"+activeTab+"']").parent().addClass("active");
	})
	 $(window).resize(function(e){
		...
		var dropDownMenuHeight = $('.dropdown-menu').height();
		 ...
		 if (dropDownMenuHeight > (windowHeight - 80)) {
			 $('.dropdown-menu').height(windowHeight - 80);
			 $('.dropdown-menu').addClass('pre-scrollable');
		}
	 }).resize()
