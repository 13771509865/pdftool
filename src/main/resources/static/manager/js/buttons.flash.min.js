(function(g) {
            ...
            if (g.isPlainObject(d))
                ...
                if (o) {
                    ...
                    for (f = i.length; e < f; e++)
                        j = d.createAttribute(i[e].name.replace(":", "_dt_b_namespace_token_")),
                        j.value = i[e].value,
                        c.setAttributeNode(j)
                }
                c = u.serializeToString(d);
                o && (-1 === c.indexOf("<?xml") && (c = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + c),
    ...
    i.Client.prototype = {
        ...
        getHTML: function(a, b) {
            ...
            if (navigator.userAgent.match(/MSIE/))
                ...
                d += '<embed id="' + this.movieId + '" src="' + i.moviePath + '" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="' + a + '" height="' + b + '" name="' + this.movieId + '" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="' + c + '" wmode="transparent" />';
            return d
        },
        hide: function() {
    ...
    var x = function(a, b) {
        ...
        for (var d = y(b), c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(e, "g"), i = b.escapeChar !== q ? b.escapeChar : "\\", k = function(a) {
            ...
            return b
        }, l = b.header ? k(c.header) + d : "", n = b.footer && c.footer ? d + k(c.footer) : "", m = [], h = 0, p = c.body.length; h < p; h++)
            m.push(k(c.body[h]));
        return {
            str: l + m.join(d) + n,
            rows: m.length
        ...
        header: !0,
        footer: !1
    }, u = "", u = "undefined" === typeof k.XMLSerializer ? new function() {
        ...
        action: function(a, b, d, c) {
            ...
            var a = c._flash, e = 0, f = g.parseXML(p["xl/worksheets/sheet1.xml"]), i = f.getElementsByTagName("sheetData")[0], d = {
                ...
                for (var b = 0, d = a.length; b < d; b++) {
                    ...
                    }) : (o = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ""),
                    j = n(f, "c", {
                        attr: {
                            t: "inlineStr",
                            r: h
            ...
            b.title && (h([b.title], e),
            m(e, j.header.length - 1));
            b.messageTop && (h([b.messageTop], e),
            m(e, j.header.length - 1));
            c.header && (h(j.header, e),
            g("row:last c", f).attr("s", "2"));
            for (var r = 0, o = j.body.length; r < o; r++)
                h(j.body[r], e);
            c.footer && j.footer && (h(j.footer, e),
            g("row:last c", f).attr("s", "2"));
            b.messageBottom && (h([b.messageBottom], e),
            m(e, j.header.length - 1));
            h = n(f, "cols");
            g("worksheet", f).prepend(h);
            m = 0;
            for (r = j.header.length; m < r; m++)
                h.appendChild(n(f, "col", {
                    attr: {
                        min: m + 1,
                        max: m + 1,
                        width: B(j, m),
