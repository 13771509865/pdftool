...
public class AuthServiceAspect {
    ...
    @AfterReturning(value = "getPermission() && args(uaaToken,authCode)", returning = "result")
    public void getPermissionAfter(UaaToken uaaToken, String authCode, IResult<Map<String,Object>> result) throws Exception {
        if (!result.isSuccess()) {
