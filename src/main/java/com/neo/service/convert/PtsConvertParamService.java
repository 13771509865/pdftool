...
public class PtsConvertParamService {
    ...
    public ConvertParameterPO buildConvertParameterPO(ConvertParameterBO convertBO, Long userId) {
        ...
        String suffix = EnumAuthCode.getSuffixByAuthCode(authCode);
        //添加后缀名
        if(StringUtils.isNotBlank(suffix)){
			String baseName = FilenameUtils.getBaseName(convertBO.getSrcRelativePath());
			String newFileName =  StringUtils.join(baseName,suffix);
			convertBO.setDestinationName(newFileName);
		}
    ...
    public static void main(String[] args) {
       String a = "2";
       String b = "ooo";
       System.out.println(StringUtils.join(b,a));
    }
}
