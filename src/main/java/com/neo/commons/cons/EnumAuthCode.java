...
public enum EnumAuthCode {
	...
	PDF_WORD(1,"PDF转Word","convert001","36","true","Pdf2word","convert001Num"),
	WORD_PDF(2,"Word转PDF","convert002","3","true","Word2pdf","convert002Num"),
	PDF_PPT(3,"PDF转PPT","convert003","80","true","Pdf2ppt","convert003Num"),
	PPT_PDF(4,"PPT转PDF","convert004","3","true","Ppt2pdf","convert004Num"),
	PDF_EXCEL(5,"PDF转Excel","convert005","81","true","Pdf2excel","convert005Num"),
	EXCEL_PDF(6,"Excel转PDF","convert006","3","true","Excel2pdf","convert006Num"),
	PDF_IMG(7,"PDF转图片","convert007","9,10,11,12,13","true","Pdf2pic","convert007Num"),
	PDF_HTML(8,"PDF转Html","convert008","14","true","Pdf2html","convert008Num"),
	PDF_MARK(9,"PDF加水印","convert009","34","true","Pdfaddstain","convert009Num"),
	PDF_SIGN(10,"PDF手写签批","convert010","14","true","Pdfaddsign","convert010Num"),
	PDF_MERGE(11,"PDF合并","convert011","31","true","Pdfmerge","convert011Num"),
	PDF_SPLIT(12,"PDF拆分","convert012","82","true","Pdfsplit","convert012Num"),
	OCR_IMG_TXT(13,"图片文字识别","convert013","83","true","Ocr","convert013Num"),
	PDF_ORC_WORD(14,"扫描件转Word","convert014","64","true","Pdftoocrword","convert014Num"),
	PIC_PDF(15,"图片转PDF","convert015","32","true","Pic2pdf","convert015Num"),
